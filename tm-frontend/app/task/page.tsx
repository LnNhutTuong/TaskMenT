...
export default function TaskPage() {
  ...
  const visibleStatusColumns = statusColumns.filter((column) =>
    visibleTasks?.some((task) => task.status === column.status),
  );
  ...
  return (
    <>
      <main className="relative flex min-h-screen flex-col px-5 py-6 font-sans text-[#f0f6fc] sm:px-8 lg:px-12">
        <div className="relative mx-auto flex w-full max-w-8xl flex-1 flex-col">
          <TaskWithId
            task={selectedTask}
          ...
          <section className="mt-3 mb-3 flex flex-col gap-3 border-b border-white/[0.08] pb-3 sm:flex-row sm:items-center sm:justify-between">
          ...
          <Card className="mb-3 overflow-hidden rounded-[22px] border border-white/[0.08] bg-[#0a0a0a] shadow-[0_24px_80px_rgba(0,0,0,0.6)]">
              ...
              {!isLoading && !errorMessage && (
                <div className="min-h-[520px]">
                  {visibleTasks?.length === 0 ? (
                    <div className="flex min-h-[520px] items-center justify-center px-5 py-16 text-center text-sm text-[#8b949e]">
                      {tasks.length === 0
                        ? "No tasks yet"
                    ...
                    <div className="grid min-w-[900px] grid-cols-3 gap-2">
                      {visibleStatusColumns.map((column) => {
                        ...
                        return (
                          <section
                            key={column.status}
                            className="flex h-[620px] flex-col rounded-xl border border-white/[0.08] bg-[#010409]"
                          >
                            ...
                            <ScrollArea className="h-1 flex-1 px-1 pb-2">
                              <div className="flex flex-col gap-2">
                                {columnTasks.map((task) => (
                                  <article
                                    ...
                                    className="flex justify-between group cursor-pointer rounded-xl border border-white/[0.08] bg-[#0d1117] p-3 shadow-sm transition hover:border-white/20 hover:bg-[#161b22]"
                                  >
                                    <div>
                                    ...
                                    <div className="mt-3 flex flex-col gap-3  justify-center items-center ">
                                      <Badge
                                        className={`px-2 py-0.5 text-[12px] ${priorityStyles[task.priority]}`}
                                      >
